...
roadmap: [
  {
    ...
    skills: [
      ...
      "Accessibility (a11y) fundamentals",                  // new
      "Cross-browser compatibility basics"                  // new
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      "State Management with Redux or Zustand",             // new
      "Handling forms (Formik, React Hook Form)",           // new
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      "Modern build tools (Vite, Webpack)",                 // new
      "WebSockets for real-time UI (basic usage)",          // new
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      "CI/CD basics for frontend (GitHub Actions, Vercel)", // new
      "Interview prep and whiteboarding with UI challenges" // new
    ],
...
roadmap: [
  ...
  },
  {
    ...
    skills: [
      ...
      "**Intro to Web Frameworks:** Express.js (Node), Flask (Python)",   // NEW
      "**Routing, middleware, and request/response lifecycle**"          // NEW
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      "**Full-stack frameworks:** Django (Python), Next.js (Node)",       // NEW
      "**ORMs and migrations:** Sequelize (Node), SQLAlchemy, Django ORM" // NEW
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      "**Framework deployment & scaling:** Django (Gunicorn + Nginx), Express (PM2), Next.js SSR static export", // NEW
      "**Serverless & edge function concepts (e.g., Vercel, Cloud Functions)**"                                     // NEW
    ],
...
roadmap: [
  {
    ...
    projects: [
      ...
      "Statistical Reports with Pandas",
  ...
  },
  {
    ...
    skills: [
      ...
      "**Intro to ML frameworks: TensorFlow & PyTorch basics**", // NEW
      "**Building simple ML apps with Streamlit or Gradio**"       // NEW
    ],
    projects: [
  ...
  },
  {
    ...
    skills: [
      ...
      "**Model serialization & serving (ONNX, TorchScript)**",       // NEW
      "**GPU acceleration and optimization (CUDA basics)**"          // NEW
    ],
    projects: [
  ...
  },
  {
    ...
    skills: [
      ...
      "**CI/CD for ML pipelines (GitHub Actions, GitLab CI)**",         // NEW
      "**Building production-grade ML APIs and dashboards**"            // NEW
    ],
    projects: [
...
roadmap: [
  {
    ...
    skills: [
      ...
      "**Wireshark for packet inspection**",                // NEW
      "**VirtualBox/VMware for isolated testing environments**"  // NEW
    ],
    projects: [
      "Network Scanning with Nmap",
      "System Hardening Checklist",
      "Security Audit on Local Machine"
    ],
  },
  {
    ...
    skills: [
      ...
      "**Burp Suite for web app testing**",                 // NEW
      "**Kali Linux as a pentesting environment**"          // NEW
    ],
    projects: [
  ...
  },
  {
    ...
    skills: [
      ...
      "**SIEM tools: Splunk, Graylog for log analysis**",   // NEW
      "**Threat intelligence tools: VirusTotal, Shodan**"   // NEW
    ],
    projects: [
  ...
  },
  {
    ...
    skills: [
      ...
      "**GRC tools: OpenSCAP, Lynis**",                    // NEW
      "**Cloud security platforms: AWS Security Hub, Azure Defender**" // NEW
    ],
    projects: [
...
roadmap: [
  {
    ...
    skills: [
      ...
      "**Emulators & simulators configuration**",                   // NEW
      "**Debugging tools (Flutter DevTools, Chrome DevTools)**"     // NEW
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      "**Styling components (Styled Components, Flutter Widgets)**", // NEW
      "**Debug builds and release builds creation**"                // NEW
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      "**Background services (WorkManager, background fetch)**",     // NEW
      "**Deep linking and dynamic links**"                           // NEW
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      "**Crash reporting (Sentry, Firebase Crashlytics)**",          // NEW
      "**App Store Optimization (ASO) techniques**"                  // NEW
    ],
...
roadmap: [
  {
    ...
    skills: [
      ...
      "**SSH, SCP, and remote access tools**",                              // NEW
      "**File system management and process monitoring**",                 // NEW
    ],
    projects: [
  ...
  },
  {
    ...
    skills: [
      ...
      "**Helm for Kubernetes package management**",                        // NEW
      "**Docker Hub and GitHub Container Registry (GHCR)**",              // NEW
    ],
    projects: [
  ...
  },
  {
    ...
    skills: [
      ...
      "**Service mesh introduction (Istio, Linkerd)**",                   // NEW
      "**Secrets management and env protection**",                        // NEW
    ],
    projects: [
  ...
  },
  {
    ...
    skills: [
      ...
      "**Incident response and runbooks**",                               // NEW
      "**Blue/Green and Canary Deployments**",                            // NEW
    ],
    projects: [
